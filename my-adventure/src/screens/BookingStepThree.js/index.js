      ...
      <div className="content">
        <div className="title">
          <h2 className="welcome">
            <mark className="highlight">Welcome To Our</mark>
          </h2>
          <h2 className="myadventure">
            <mark className="highlight">My Adventure</mark>
          </h2>
        ...
        <div className="form">
          ...
          <div className="bookingForm">
            ...
            >
              ...
              <div style={{ fontSize: "3vh", marginLeft: "5.6vw" }}>Plane</div>
            </div>
            ...
            >
              ...
              <div style={{ fontSize: "3vh", marginLeft: "11vw" }}>3 stars</div>
            </div>
