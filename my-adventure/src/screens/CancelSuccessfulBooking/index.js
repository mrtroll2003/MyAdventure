...
const CancelSuccessfulBooking = () => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.hi}>Hi, our beloved customers!</div>
      ...
      <div className={styles.mainContentContainer}>
        <div className={styles.title1}>Your Booking</div>
        ...
        <div className={styles.warnings}>ARE YOU SURE TO CANCEL?</div>
        <div className={styles.caution}>
          If you cancel this booking, you will lose:<br></br>
          <b>8% fee</b> charged <b>2 weeks to 1 month</b> before departure date
          <br></br>
          <b>20% fee</b> charged <b>2 weeks</b> before departure date<br></br>
          <br></br>
          If you accept our company policy, please fill in below information to
          be received fee from this booking cancellation.
        </div>

        {showMessage && (
          <div className={styles.message}>Please fill all information!</div>
        )}
        <div className={styles.infoBox}>
          ...
          >
            <motion.option value="" disabled selected>
              --Choose an option--
            </motion.option>
      ...
      <div className={styles.welcome}>
        When you click “Submit” button, it will takes about 1 week or 2 weeks to
        handle this refund.
      </div>
