    ...
    <div>
      <div className={styles.content}>
        ...
        <div className={styles.bookingprogress}>
          ...
          <img src={require("../../assets/icons/2inprogress.png")} alt='2inprogress' className={styles.marginleft}/>
          <div className={styles.nameofprogress}>Your information</div>
          <img src={require("../../assets/icons/line.png")} alt='line' className={styles.marginleft}/>
          <img src={require("../../assets/icons/3nextstage.png")} alt='3nextstage' className={styles.marginleft}/>
              ...
              <div className={styles.yourSelectionTable}>
                <div className={styles.columnDirection}>
                  ...
                  <div className={styles.infoContainer}>
                    ...
                    <div className={styles.infoText}>Departure and Destination:</div>
                  </div>
                  <div className={styles.infoContainer}>
                ...
                <div className={styles.columnDirection}>
                  <div className={`${styles.infoContainer} ${styles.infoText1}`}>30/09/2023 - 15/10/2023</div>
                  <div className={`${styles.infoContainer} ${styles.infoText1}`}>Sài Gòn - Sapa</div>
                  <div className={`${styles.infoContainer} ${styles.infoText1}`}>2 persons</div>
                  <div className={`${styles.infoContainer} ${styles.infoText1}`}>2 persons</div>
                </div>
              </div>
            </div>
        ...
        <div className={styles.form}>
          ...
          <div className={styles.bookingForm}>
            ...
            <div className={styles.heading1} style={{marginTop: "6vh",}}>2. Travel's Information</div>
              ...
              <div className={styles.heading2}>Kinds of transportation<span style={{color: "red"}}>*</span>:</div>
            ...
            <div style={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "4vh"}}>
              <div className={styles.heading2}>Range of hotel<span style={{color: "red"}}>*</span>:</div>
              <div style={{fontSize: "3vh"}}>
            ...
            <div style={{display: "flex", flexDirection: "row", alignItems: "center",  marginTop: "4vh"}}>
              <div className={styles.heading2}>Kinds of Tour<span style={{color: "red"}}>*</span>:</div>
              <div style={{fontSize: "3vh",}}>
            ...
            <div style={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "4vh", paddingBottom: "3vh"}}>
              <div className={styles.heading2} style={{marginTop: "0"}}>Expected Departure Date<span style={{color: "red"}}>*</span>:</div>
              <div>
                <DatePicker popupStyle={{ zIndex: 9999, position: 'fixed' }}  selected={departuretDate} onChange={(date) => setDeparturetDate(date)} dateFormat={"dd/MM/yyyy"}  className={styles.datePicker} />
              </div>
            </div>  
              </div>
          </div>
