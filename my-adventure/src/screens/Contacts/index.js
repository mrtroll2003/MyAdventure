      ...
      >
        ...
        <div className={styles.horizon}>
          ...
          <p className={styles.normalText}>
            123 Nguyễn Thị Minh Khai, phường Phạm Ngũ Lão, Quận 1, TP. Hồ Chí
            Minh
          </p>
          <br></br>
        </div>
        <div className={styles.horizon}>
          ...
          <p className={styles.normalText}>Hotline: (+89) 123456789</p>
          <br></br>
        </div>
        <div className={styles.horizon}>
          <img src={PhoneIC} className={styles.icon}></img>
          <p className={styles.normalText}>WhatsApp: (+89) 123456789</p>
          <br></br>
        </div>
        <div className={styles.horizon}>
          <img src={EmailIC} className={styles.icon}></img>
          <p className={styles.normalText}>myadvanture@gmail.com</p>
          <br></br>
        </div>
      </div>
      <Footer />
