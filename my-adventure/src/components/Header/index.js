  ...
  render() {
    return (
      <div className='header'> 
        ...
        <motion.p className='text'  whileHover={{color: 'blue'}} whileTap={{opacity: 0.5, transition:{duration: 0.1}}} >(+89) 123456789</motion.p>
        ...
        <motion.p className='text'  whileHover={{color: 'blue'}} whileTap={{opacity: 0.5, transition:{duration: 0.1}}}>myadvanture@gmail.com</motion.p>
        <motion.p style={{marginLeft: '25%',}} className='text'>Get to know us</motion.p>
