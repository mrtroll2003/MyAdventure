...
const CreateVietNamTourScreen = (props) => {
  ...
  const AddTour = async () => {
    ...
    const handleSubmit = async (e) => {
      if(transportBrand === "" || accomodation === "" || departureDate === undefined || returnDate === undefined || checkinDate === undefined || checkoutDate === undefined || price === "" || details === "" || depature === "" || destination === "" ) {
  ...
  return (
    <>
      ...
      <div className={styles.horizontal}>
            ...
            >
              <motion.option key="choose" value="choose" disabled>--Choose a departure--</motion.option>
